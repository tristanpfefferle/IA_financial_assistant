...
def build_default_loops() -> list[Any]:
    ...
    return [
        ...
        DeterministicLoop("onboarding.profile_confirm", True, "Confirme ton profil.", yes_no, ("profile_confirm",), "onboarding.bank_accounts_collect"),
        ...
        DeterministicLoop("onboarding.bank_accounts_confirm", True, "Confirme la liste des comptes.", yes_no, ("bank_accounts_confirm",), "onboarding.import_select_account"),
        ...
        DeterministicLoop("onboarding.import_wait_ready", True, "Ton fichier CSV est-il prêt pour l’import ?", yes_no, ("import_wait_ready",), "onboarding.categories_intro"),
